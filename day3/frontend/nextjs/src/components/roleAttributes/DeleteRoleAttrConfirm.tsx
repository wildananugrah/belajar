import { deleteRoleAttribute } from "@/helpers/role-attr.helper";

const DeleteRoleAttrConfirm = ({
  current,
  items,
  setItems,
  setDeleteModal,
    ...
    <div className="flex flex-col justify-center items-center w-full space-y-3">
      ...
      <div className="flex flex-row justify-between items-center w-full space-x-2">
        <button
          ...
          data-cyid="deleteRoleAttrButton"
          onClick={async (e) => {
            e.preventDefault();
            e.stopPropagation();
            ...
            deleteRoleAttribute(current.id);
...
export default DeleteRoleAttrConfirm;
